...
public class SaveFragmentDirections {
  ...
  @NonNull
  public static ActionTitleSaveToDetail actionTitleSaveToDetail() {
    return new ActionTitleSaveToDetail();
  }

  public static class ActionTitleSaveToDetail implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionTitleSaveToDetail() {
    }

    @NonNull
    public ActionTitleSaveToDetail setArticle(@Nullable Article article) {
    ...
    public int getActionId() {
      return R.id.action_title_save_to_detail;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionTitleSaveToDetail that = (ActionTitleSaveToDetail) object;
    ...
    public String toString() {
      return "ActionTitleSaveToDetail(actionId=" + getActionId() + "){"
          + "article=" + getArticle()
          + "}";
    }
  }
